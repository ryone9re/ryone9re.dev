...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const paths = PageRange(1, Math.ceil(data.totalCount / PER_PAGE)).map((repo) =>  `/blog/page/${repo}`)
...
export default function Blog({ contents, totalCount }: { contents: Article[], totalCount: number }): JSX.Element {
